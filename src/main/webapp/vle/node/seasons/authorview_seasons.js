...
View.prototype.SeasonsNode.generatePage = function(view){
   ...
   */
	...
	'<option value="whatTemperaturePatternsDoYouSee">調查：世界的溫度型態</option>' +
	'<option value="whatTemperaturePatternsDoYouSeeLite">探索：世界的溫度型態</option>' +
	'<option value="whatIstheShapeofEarthsOrbit">地球運行軌道的形狀</option>' +
	'<option value="howDoesEarthsTiltAffectTemperature">調查：地球傾斜如何影響溫度</option>' +
	'<option value="howDoesEarthsTiltAffectTemperatureLite">探索：地球傾斜如何影響溫度</option>' +
	'<option value="howDoesEarthsTiltAffectHoursOfDaylight">調查：地球傾斜與日夜長短</option>' +
	'<option value="howDoesEarthsTiltAffectHoursOfDaylightLite">探索：地球傾斜與日夜長短</option>' +
	'</select>';

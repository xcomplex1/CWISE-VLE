/**
 * Sets the BranchingNode type as an object of this view
 * 
 * TODO: rename BranchingNode
 * 
 * @constructor
 */
View.prototype.BranchingNode = {};
 ...
 * TODO: rename BranchingNode
 */
View.prototype.BranchingNode.commonComponents = [];
 ...
 * TODO: rename BranchingNode
 */
View.prototype.BranchingNode.generatePage = function(view){
	this.view = view;
	 ...
	 * 
	 * onkeyup will fire the 'branchingUpdatePrompt' event which will
	 ...
	 */
	var promptTextArea = createElement(document, 'textarea', {id: 'promptTextArea', rows:'20', cols:'85', onkeyup:"eventManager.fire('branchingUpdatePrompt')"});
 ...
 * TODO: rename BranchingNode
 */
View.prototype.BranchingNode.getCommonComponents = function() {
 ...
 * TODO: rename BranchingNode
 */
View.prototype.BranchingNode.updateContent = function(){
 ...
 * TODO: rename BranchingNode
 */
View.prototype.BranchingNode.populatePrompt = function() {
 ...
 * TODO: rename BranchingNode
 */
View.prototype.BranchingNode.updatePrompt = function(){
	/* update content */
...
if(typeof eventManager != 'undefined'){
	 ...
	 * TODO: rename authorview_branching
	 * 
	 * e.g. if you were creating a quiz step it would look like
	 * 
	 * eventManager.fire('scriptLoaded', 'vle/node/quiz/authorview_quiz.js');
	 */
	eventManager.fire('scriptLoaded', 'vle/node/branching/authorview_branching.js');
};